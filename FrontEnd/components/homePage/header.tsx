...
export const Header = () => {
  ...
  return (
    <>
      ...
      >
        <div className="min-w-[350px] lg:min-w-[400px] text-center text-5xl text-slate-900 dark:text-slate-200 md:text-right lg:text-6xl  ">
          <h1 className=" w-fit m-auto md:w-full md:m-0  flex items-center font-bold whitespace-nowrap">
            قال رسول الله
            <h1>ﷺ</h1>
          </h1>
          <p className="my-7 text-4xl lg:text-5xl font-quran">
